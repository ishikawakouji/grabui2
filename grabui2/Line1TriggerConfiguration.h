...
#ifndef INCLUDED_SOFTWARETRIGGERCONFIGURATION_H_4655834_2
#define INCLUDED_SOFTWARETRIGGERCONFIGURATION_H_4655834_2
...
namespace Pylon
{
    ...
    */
    class CLine1TriggerConfiguration : public CConfigurationEventHandler
    {
    public:
